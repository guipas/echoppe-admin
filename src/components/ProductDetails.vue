    ...
    <div class="product" v-if="product">
      <content-card>
        ...
        <div class="product-form-element product-name">
          <label>Name :</label>
          <input type="text" class="" v-model="product.name"/>
        </div>
        <div class="product-form-element product-description">
          <label>Description :</label>
          <textarea class="" v-model="product.description"></textarea>
        </div>
        <div class="product-form-element product-images-upload">
          <div v-if="product.id">
            <label>Images upload :</label>
            <input :disabled="!product.id" type="file" multiple id="product-details-uploads" />
        ...
        <div class="product-form-element product-quantity">
          ...
          <input type="text" class="" v-model="product.stock"/>
        </div>
        <div class="product-form-element product-price">
          <label>Price :</label>
          <input type="text" class="" v-model="product.price"/>
        </div>
        ...
        <hr/>
        <div class="product-delete tr pt4">
          <danger-button class="" v-on:click.native="deleteProduct">Delete</danger-button>
        </div>
      </content-card>
    </div>
  </div>
